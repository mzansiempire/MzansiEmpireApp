...
@endif	
			{!! Form::open(array('url'=>'accounttypecontroller/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'accounttypecontrollerFormAjax')) !!}
			<div class="col-md-12">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("accounttypecontroller/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#accounttypecontrollerFormAjax'); 
	form.parsley();
