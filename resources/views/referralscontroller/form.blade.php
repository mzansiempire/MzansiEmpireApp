...
@endif	
			{!! Form::open(array('url'=>'referralscontroller/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'referralscontrollerFormAjax')) !!}
			<div class="col-md-12">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("referralscontroller/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#referralscontrollerFormAjax'); 
	form.parsley();
